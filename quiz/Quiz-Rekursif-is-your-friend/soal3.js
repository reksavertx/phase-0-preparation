...
function consonantCounterRecursive(sentences) {
  ...
  if (!isNaN(Number(sentences[0]))) {
    return 0 + consonantCounterRecursive(sentences.slice(1).join(""))
  } else if(sentences[0].toLowerCase() === "a" || sentences[0].toLowerCase() === "i" || sentences[0].toLowerCase() === "u" || sentences[0].toLowerCase() === "e" || sentences[0].toLowerCase() === "o") {
    return 0 + consonantCounterRecursive(sentences.slice(1).join(""))
  }

  return 1 + consonantCounterRecursive(sentences.slice(1).join(""))
}
