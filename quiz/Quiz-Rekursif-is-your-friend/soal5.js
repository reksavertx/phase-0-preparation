...
function hapusSimbolRec(str) {
  ...
  str = str.split("")
    ...
    if(isNaN(Number(str[0])) === false && str[0] !== " ") {
        return str[0] + hapusSimbolRec(str.slice(1).join(""))

    } else if (str[0].toLowerCase() !== str[0].toUpperCase()) {
  ...
  return hapusSimbolRec(str.slice(1).join(""))
}

console.log(hapusSimbolRec("JSBJABHBSAHBAHBSH"))
